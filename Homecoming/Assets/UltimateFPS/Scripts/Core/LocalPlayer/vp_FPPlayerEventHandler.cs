...
public class vp_FPPlayerEventHandler : vp_StateEventHandler
{
	...
	public vp_Message<bool> Test_message;
	public vp_Value<int> hp;
	...
	//diko moy
	public vp_Activity ContinuousInteract;
	public vp_Activity AlternativeInteract;
	public vp_Activity AlternativeAttack;
