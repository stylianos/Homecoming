...
public abstract class vp_Interactable : MonoBehaviour
{
	...
	/// <summary>
	/// This should be overriden and starts the continuous_interaction
	/// </param>
	
	public virtual bool TryContinuousInteract(vp_FPPlayerEventHandler player)
	{
		return false; // if not overridden, just prevent interaction
		
	}

	public virtual bool TryAlternativeInteract(vp_FPPlayerEventHandler player)
	{
		Debug.Log("geaiaiaa");
		return false; // if not overridden, just prevent interaction
