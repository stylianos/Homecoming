...
public class vp_PlayerDamageHandler : vp_DamageHandler
{
	...
	public states_handler player_state;
	public bool about_to_die = false;
	...
	public void Start(){
		player_state = GameObject.Find("my_player").GetComponent<states_handler>();
		game_logic = GameObject.Find("Game_logic");
	}
	...
	public override void Die()
	{
		if (!player_state.calm){
			game_logic.GetComponent<game_logic>().is_zombie = true;
			return;
		}
