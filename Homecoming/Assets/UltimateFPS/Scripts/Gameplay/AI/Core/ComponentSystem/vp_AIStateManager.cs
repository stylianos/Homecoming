...
public class vp_AIStateManager
{

	private vp_AIComponent m_Component = null;			// component to manipulate
	private List<vp_AIState> m_States = null;			// list sent from the component at startup. IMPORTANT: must not be altered at runtime
	...
	/// </summary>
	public void ImposeBlockingList(vp_AIState blocker)
	{
	...
	/// </summary>
	public void RelaxBlockingList(vp_AIState blocker)
	{
	...
	{	
		...
		for(int v = m_States.Count - 1; v > -1; v--)
		{
			...
			vp_AIComponentPreset.Apply(m_Component, m_States[v].Preset);
