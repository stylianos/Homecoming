...
public sealed class vp_AIComponentPreset
{
	...
	{
		vp_AIComponentPreset preset = new vp_AIComponentPreset();
	...
	/// saves every supported field of 'preset' to text at 'fullPath'
	/// </summary>
	public static string Save(vp_AIComponentPreset savePreset, string fullPath, bool isDifference = false)
	{
	...
	/// </summary>
	public static string SaveDifference(vp_AIComponentPreset initialStatePreset, Component modifiedComponent, string fullPath, vp_AIComponentPreset diskPreset)
	{
		...
		vp_AIComponentPreset modifiedPreset = new vp_AIComponentPreset();
		modifiedPreset.InitFromComponent(modifiedComponent);

		// create an empty preset of the same type
		vp_AIComponentPreset result = new vp_AIComponentPreset();
	...
	/// </summary>
	public static vp_AIComponentPreset CreateFromComponent(Component component)
	{
	...
	/// </summary>
	public static vp_AIComponentPreset LoadFromResources(Component component, string resourcePath)
	{
	...
	/// the values on 'component', then returns the preset
	/// </summary>
	public static vp_AIComponentPreset LoadFromTextAsset(Component component, TextAsset file)
	{
	...
	/// </summary>
	public static bool Apply(Component component, vp_AIComponentPreset preset)
	{
